...
public class Configs {
    ...
    public static final List<Double> thresholdsList = Arrays.asList(1.0, 10.0,
	    20.0, 50.0, 100.0, 200.0, 500.0, 1000.0, 15000.0, 20000.0);
    public static final String FILENAME_THRESHOLD_COUNT = "thresholdCount.txt";

    public enum MeanAlgorithm {
	ARITHMETIC_MEAN("arithmetic"), WEIGHTED_ARITHMETIC_MEAN("weighted"), GEOMETRIC_MEAN(
		"geometric");

	private String name;

	MeanAlgorithm(final String name) {
	    this.name = name;
	}
    }
}
